...
def main():
    ...
    with open(gse_output_csv, 'a', newline='') as csvfile:
        ...
        csvwriter.writerow(["GSE", "GSE_Title", "GSE_Pubmed_ID", "GSE_Last_Update_Date", "GSE_Release_Date", "GSE_URL",'Matched_key','Matched_key_word'])
    ...
    if need_parser_GSE:
        ...
        for gseid in gdsSamples:
            p_f.get_meta_url(gseid,gse_output_csv,gse_gsm_output_csv,
                             path = geo_path,
